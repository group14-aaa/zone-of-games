...
const getGamesByGenreIdAndPlatformId = (genreId, platformId, pageNumber) => axiosCreateRawgApi.get("/games?key=" + import.meta.env.VITE_RAWG_API_KEY + "&genres=" + genreId + "&platforms=" + platformId + "&page=" + pageNumber);
